...
# [#](https://cmux.com/docs/getting-started#title)Getting Started
...
## [#](https://cmux.com/docs/getting-started#install)Install

### [#](https://cmux.com/docs/getting-started#dmg-recommended)DMG (recommended)
...
### [#](https://cmux.com/docs/getting-started#homebrew)Homebrew
...
## [#](https://cmux.com/docs/getting-started#verify-title)Verify installation
...
## [#](https://cmux.com/docs/getting-started#cli-setup)CLI setup
...
## [#](https://cmux.com/docs/getting-started#auto-updates)Auto-updates
...
## [#](https://cmux.com/docs/getting-started#session-restore)Session restore (current behavior)
...
See the [session restore guide](https://cmux.com/docs/session-restore) for agent hook setup and the supported resume matrix.

## [#](https://cmux.com/docs/getting-started#requirements)Requirements

-   macOS 14.0 or later
-   Apple Silicon or Intel Mac

[cmux TUI](https://cmux.com/docs/tui)
