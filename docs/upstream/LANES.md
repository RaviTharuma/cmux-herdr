...
| **B. Tmux-depth contract** | This chat (`bc-19886765-137b-4458-bb10-d6b48d0d6e7a`) | **New files only.** Plugin impose/host/io/session/**control**. Native twins on **separate** fork branches | Do **not** commit onto `cursor/nested-topology-herdr-v1-becf` until lane A finishes 5/5 |
...
- Plugin control-depth: `bridge/cmux_herdr_control.py` (named keys, seed, focus rollback, user split, activity, detach)
